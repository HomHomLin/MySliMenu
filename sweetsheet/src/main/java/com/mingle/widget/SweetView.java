...
//        mPaint.setStyle(Paint.Style.FILL);
    ...
    private void drawBG(Canvas canvas) {
        ...
        switch (mStatus){
            ...
            case STATUS_UP:
                currentPointY=getWidth()-(int) ((getWidth()-mMaxArcHeight)* Math.min(1,(mArcHeight-mMaxArcHeight /4 )* 2.0 / mMaxArcHeight * 1.3));
//                currentPointY=getHeight()-(int) ((getHeight()-mMaxArcHeight)* Math.min(1,(mArcHeight-mMaxArcHeight /4 )* 2.0 / mMaxArcHeight * 1.3));
        ...
        mPath.moveTo(currentPointY, 0);
        mPath.quadTo(currentPointY - mArcHeight, getHeight() / 2, currentPointY, getHeight());
        mPath.lineTo(getWidth(), getHeight());
        mPath.lineTo(getWidth(), 0);
        mPath.lineTo(currentPointY, 0);
