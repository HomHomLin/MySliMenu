...
//	mSweetView.setSweetSheetColor(sweetSheetColor);
        ...
        if(mContentViewWidth > 0){
            mFreeGrowUpParentRelativeLayout.setContentWidth(mContentViewWidth);
        }
    ...
    public  CustomDelegate setContentWidth(int width){

        if(width >0 && mFreeGrowUpParentRelativeLayout != null){
            mFreeGrowUpParentRelativeLayout.setContentWidth(width);
        }else{
